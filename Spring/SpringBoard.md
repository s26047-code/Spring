...
- **Spring Boot**  
Spring을 쉽게 쓰게 해주는 프레임워크이다.

- **Spring MVC**  
각 부분을 독립적으로 개발하고 변경할 수 있도록 하는 소프트웨어 패턴이다. (Model → Controller → View)

- **JPA (Java Persistence API)**  
데이터 베이스와 연결 후 데이터 저장/조회를 쉽게 해준다  
...
스트링 부트의 기본 구조이다.  
<span style="color: gray;"><small>출처 https://hoyeong-rithm.tistory.com/103</small></span>
...
<span style="color: gray;">JSON = 데이터를 주고받기 위한 key-value</span>
